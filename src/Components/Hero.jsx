            ...
            <div className='flex flex-wrap'>
                <div className='w-full lg:w-1/2'>
                    <div className='flex flex-col items-center lg:items-start'>
                        <h1 className='pb-10 text-6xl font-thin tracking-tight lg:mt-12 lg:text-7xl'>Sirajul Munir</h1>
                        ...
                        <p className='my-2 max-w-xl py-3 font-light tracking-tighter'>{HERO_CONTENT}</p>
                    </div>
                </div>
